...
router.post('/', auth_1.authMiddleware, (0, auth_1.requireRole)([client_1.Role.ADMIN, client_1.Role.STAFF]), notices_1.createNotice);
router.put('/:id', auth_1.authMiddleware, (0, auth_1.requireRole)([client_1.Role.ADMIN, client_1.Role.STAFF]), notices_1.updateNotice);
