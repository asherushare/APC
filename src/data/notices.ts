...
export const notices: Notice[] = [
  {
    id: 'pm-kisan-2026',
    title: 'PM-KISAN 17th Installment Release & e-KYC Verification',
    date: '2026-06-10',
    category: 'scheme',
    summary: 'The government has announced the release of the 17th installment of PM-KISAN. All beneficiary farmers must complete their e-KYC verification immediately to receive the benefit.',
    content: 'The Pradhan Mantri Kisan Samman Nidhi (PM-KISAN) is a central sector scheme providing income support of ₹6,000 per year in three equal installments to all landholding farmers families across the country. The 17th installment is scheduled for release. To ensure uninterrupted transfer, farmers must complete their e-KYC before the deadline. APC centers are equipped to help you complete OTP-based or biometric e-KYC free of service charge.',
    pdfUrl: '/documents/pm-kisan-guide.pdf'
  },
  {
    id: 'subhadra-yojana-2026',
    title: 'Subhadra Yojana Odisha: Eligibility and Application Procedure',
    date: '2026-06-08',
    category: 'scheme',
    summary: 'Detailed guidelines and forms for the Subhadra Yojana are now available. Tribal women aged 21-60 are eligible for financial assistance of ₹10,000 per year.',
    content: 'Under the Subhadra Yojana launched by the Government of Odisha, eligible women beneficiaries will receive a financial assistance of ₹10,000 per annum in two installments (on Rakhi Purnima and Women’s Day). Applications can be submitted online or offline. APC centers are hosting special desks to facilitate applications, verify documents, and ensure bank account Aadhaar linkages are active.',
    pdfUrl: '/documents/subhadra-yojana-form.pdf'
  },
  {
  ...
  {
    id: 'new-digital-center-bissamcuttack',
    title: 'New APC Digital Services Helpdesk Opened in Bissamcuttack',
    date: '2026-05-20',
    category: 'announcement',
  ...
  },
  {
    ...
    title: 'Success Story: Turmeric Farmers of Muniguda Reach National Markets',
    date: '2026-05-15',
    category: 'story',
  ...
  {
    id: 'caste-certificate-drive-success',
    title: 'Over 800 Tribal Students Secure Education Certificates in 3 Months',
    date: '2026-05-02',
    category: 'story',
