...
const slides = [
  {
    ...
    badge: 'Cooperative Farmer Ownership',
    title: 'Empowering Adivasi Farmers Through Cooperative Ownership',
    description: 'Unlocking economic prosperity for tribal farming families. We combine age-old agricultural heritage with direct market linkages, digital operations, and communal capital to create resilient, self-governing producer systems across Odisha.',
    ctaPrimary: 'Become a Shareholder',
    ctaPrimaryHref: '/join',
    ctaSecondary: 'Access Member Portal',
    ctaSecondaryHref: '/portal',
  },
  {
    image: '/images/hero-services.jpg',
    badge: 'APC Digital',
    title: 'Bringing Digital Governance to the Grassroots',
    description: 'Providing caste certificates, land records, Aadhaar updates, and direct access to essential government welfare schemes at the village cooperative level.',
  ...
  },
  {
    ...
    title: 'Fair Trade, Direct Markets & Value Addition',
    description: 'Connecting tribal turmeric, millet, and forest produce growers directly to national buyers, eliminating middlemen, and securing higher prices.',
    ctaPrimary: 'Learn About Us',
    ctaPrimaryHref: '/about',
    ctaSecondary: 'Read Notices Board',
  ...
  },
  {
    ...
    description: 'Organizing Grading, Processing, and Local Retail networks for tribal women self-help groups to secure financial autonomy.',
    ctaPrimary: 'Become a Shareholder',
    ctaPrimaryHref: '/join',
